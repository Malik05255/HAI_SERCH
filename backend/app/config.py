...
class Settings(BaseSettings):
    ...
    # queue.py spreads 48 attempts over roughly 48 hours of backoff, plus
    # actual processing time, so long searches can run for about two days
    # without keeping CPU busy continuously.
