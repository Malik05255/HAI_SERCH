...
if manifest.exists():
    ...
    # Adaptive/round launcher resources are generated by generate_icon.py.
    # Do not reference them here: this script must remain safe when developers
    # only recreate Flutter platform files and build with the legacy launcher.
